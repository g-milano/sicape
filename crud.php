...
else if(isset($_REQUEST['autenticate']))
{
	...
	{
		if ($_SESSION['user']->roleName=='participante')
		{

			echo '<script language="JavaScript1.1">window.location="'.$GLOBALS["baseURL"].'cuenta"</script>';
		}
		...
		else if($_SESSION['user']->roleName == 'participante')
		{
			echo '<script language="JavaScript1.1">window.location="'.$GLOBALS["baseURL"].''.$GLOBALS["DEFAULT_VIEW"].'";</script>';
